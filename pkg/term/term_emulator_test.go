...
func TestParseAnsiCommand(t *testing.T) {
	...
	// Multiple Escape sequence ESC[[
	c = ParseAnsiCommand(StringToBytes("\x1B[[m"))
	Assert(t, c.Command == "m", "Command should be m")
	Assert(t, "" == c.GetParam(0), "should return empty string")
	Assert(t, "" == c.GetParam(1), "should return empty string")
	*/
}

func newMockTerm(stdOut io.Writer, stdErr io.Writer, stdIn io.Reader) (*Terminal, *mockTerminal) {
	mock := &mockTerminal{
...
func newBufferedMockTerm() (*Terminal, *mockTerminal) {
	var input bytes.Buffer
	var output bytes.Buffer
	var err bytes.Buffer
	return newMockTerm(&output, &err, &input)
}

func TestOutputSimple(t *testing.T) {
	term, mock := newBufferedMockTerm()

	term.StdOut.Write(StringToBytes("Hello world"))
	term.StdOut.Write(StringToBytes("\x1BmHello again"))
...
func TestOutputSplitCommand(t *testing.T) {
	...
	term.StdOut.Write(StringToBytes("Hello world\x1B[1;2;3"))
	term.StdOut.Write(StringToBytes("mHello again"))
...
func TestOutputMultipleCommands(t *testing.T) {
	...
	term.StdOut.Write(StringToBytes("Hello world"))
	term.StdOut.Write(StringToBytes("\x1B[1;2;3m"))
	term.StdOut.Write(StringToBytes("\x1B[J"))
	term.StdOut.Write(StringToBytes("Hello again"))
...
func helpsTestOutputSplitThreeChunksAtIndex(t *testing.T, data []byte, i int, j int) {
	...
	term.StdOut.Write(data[:i])
	term.StdOut.Write(data[i:j])
	term.StdOut.Write(data[j:])
